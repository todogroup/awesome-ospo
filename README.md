...
- [Azure Credits by Microsoft](https://cloudblogs.microsoft.com/opensource/2021/09/28/announcing-azure-credits-for-open-source-projects/) This program grants Azure credits to open source projects for a year. Developers will be able to use these credits for testing, storage, or other development.
