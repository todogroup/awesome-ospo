...
- [EasyCLA](https://github.com/communitybridge/easycla) - CLA of LFX Foundation which lets project contributors read, sign, and submit contributor license agreements easily
