...
- [MulanPSL v2](https://license.coscl.org.cn/MulanPSL2) - Mulan Permissive Software License v2, the first open source license originating from China to receive OSI approval. Provides explicit patent grant clauses and bilingual (Chinese/English) legal text, making it suitable for projects operating under Chinese legal environments.
