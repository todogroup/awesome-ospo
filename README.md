...
- [Forker](https://github.com/marketplace/actions/github-forker) - GitHub action that can be used to automate self-service workflows for allowing users to fork repositories while maintaining License compliance.
